...
export default function Home() {
    return (
        <main className='flex-center'>
            <section id='mvv-company' className='w-full grid grid-cols-1 gap-16 sm:gap-8 md:gap-y-16 xl:gap-8 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3'>
